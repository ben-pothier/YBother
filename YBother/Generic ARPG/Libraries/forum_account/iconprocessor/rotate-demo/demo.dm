...
mob
	Login()
		...
		// create an instance of the rotate processor that turns the
		// icons by 30 degrees
		var/Rotate/rotate = new(30)

		// process the sample icon
		var/icon/result = rotate.process('icon-processor-demo-icons.dmi')

		// save the result as "rotate.dmi"
		src << ftp(result, "rotate.dmi")
